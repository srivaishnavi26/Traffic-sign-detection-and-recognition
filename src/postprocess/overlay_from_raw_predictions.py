...
OUT_PATH = Path("runs/final/BKS_raw.mp4")
...
with open(PRED_FILE) as f:
    for line in f:
        ...
        frame_predictions[frame_id] = label

print("Loaded raw predictions:", len(frame_predictions))
...
print("Video generated using RAW predictions")